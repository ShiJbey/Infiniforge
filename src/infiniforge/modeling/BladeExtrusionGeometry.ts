...
//  * their 3D geometry
//  */
// export class BladeExtrusionGeometry extends GeometryData {
//   /** The final desire length of the blade */
//   private readonly _totalLength: number;
//   /** The current length of the blade */
//   private _currentLength: number;
//   /** The current curve of the edge(s) */
...
//   /** The cross section at the top of the extrusion */
//   private _activeCrossSection?: BladeCrossSection;
...
//     crossSection: BladeCrossSection,
//     edgeVerts: number[],
//     color?: THREE.Color,
//     normEdges?: number[],
...
//     const modifiedCrossSection = new BladeCrossSection({
//       vertices: verts,
//     });
...
//   setCrossSection(crossSection: BladeCrossSection): this {
...
//     const newCrossSection = new BladeCrossSection();
...
//   translate(distance: THREE.Vector3): this {
//     if (!this._activeCrossSection) {
//       throw new Error(
//         "GeometryData does not have an active cross section to translate."
//       );
...
//   scale(scaleFactor: THREE.Vector2): this {
//     if (!this._activeCrossSection) {
//       throw new Error(
...
//   extrude(direction: THREE.Vector3): this {
