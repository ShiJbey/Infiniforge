...
class GLTFExporter {
    ...
    parse(input, onDone, options) {
        ...
        function isPowerOfTwo(image) {
            return three_1.MathUtils.isPowerOfTwo(image.width) && three_1.MathUtils.isPowerOfTwo(image.height);
        }
        ...
        function processMaterial(material) {
            ...
            else if (material instanceof three_1.MeshBasicMaterial) {
            ...
            for (var i = 0, il = groups.length; i < il; i++) {
                ...
                if (groups[i].materialIndex !== undefined) {
                    if (Array.isArray(materials)) {
                        var material = processMaterial(materials[(_a = groups[i].materialIndex) !== null && _a !== void 0 ? _a : 0]);
                    }
                }
                else {
